...
<main class="section">
	<div class="container">
		...
		<div class="box">
			...
			<div class="control">
				<button class="button is-primary" on:click="{handleFetch}"
					>Fetch Data</button
				>
			</div>
		</div>
		...
		{#if campaignData}
			<div class="box">
					...
					<div class="control">
						<div class="select is-multiple">
							<select
								...
								id="categories"
							>
								{#each [{ name: "Web3" }, { name: "License-UNKNOWN" }, { name: "Travel" }, { name: "Random" }, { name: "SocialMedia" }, { name: "Hardware" }, { name: "Informative" }, { name: "Education" }, { name: "License-Proprietary" }, { name: "SLP" }, { name: "License-MPL2" }, { name: "Infrastructure" }, { name: "Marketing" }, { name: "SCAM?" }, { name: "Crowdfunding" }, { name: "Adoption" }, { name: "License-Apache2" }, { name: "Usecase" }, { name: "Wallet" }, { name: "VideoGame" }, { name: "Humanitarian" }, { name: "License-MIT" }, { name: "License-GPLv3" }, { name: "Hackathon" }, { name: "Healthcare" }, { name: "Documentary" }, { name: "News" }, { name: "Rewards" }, { name: "License-AGPLv3" }, { name: "Charity" }, { name: "Developer" }, { name: "Gaming" }, { name: "NFT" }, { name: "Software" }, { name: "Video" }, { name: "Remittance" }, { name: "Other" }, { name: "SmartBCH" }, { name: "DeFi" }] as category}
				...
				<div class="control">
					<button class="button is-primary" on:click="{handleReview}"
